...
- It is **never uploaded** or sent over any network.
- No images or video ever leave your Mac.
- The app makes **no network connections** and has **no servers**.

## Accounts & tracking
There are no accounts, no sign-in, no analytics, no advertising, and no
third-party SDKs. Nothing about your usage is tracked.

## Settings
Your preferences (sensitivity, alert style, etc.) are stored locally on your Mac
...
## Contact
For questions about this policy, please reach out via the app's support page.
